...
$sapcarUri = $baseUri + "/SapBits/SAP_HANA_STUDIO/sapcar.exe" + $artifactsLocationSasToken
$hanastudioUri = $baseUri + "/SapBits/SAP_HANA_STUDIO/IMC_STUDIO2_212_2-80000323.SAR" + $artifactsLocationSasToken
$jreUri = $baseUri + "/SapBits/SAP_HANA_STUDIO/serverjre-9.0.1_windows-x64_bin.tar.gz" + $artifactsLocationSasToken
$7zUri = "http://www.7-zip.org/a/7z1701-x64.msi"
$sapacardest = "C:\SapBits\SAP_HANA_STUDIO\sapcar.exe"
...
cd C:\SAPbits\SAP_HANA_STUDIO\SAP_HANA_STUDIO\studio
.\hdbinst.exe -a C:\SAPbits\SAP_HANA_STUDIO\studio -b --path="C:\Program Files\sap\hdbstudio"